...
export default async function Home() {
    return (
        <main className="min-h-screen overflow-hidden" style={{ backgroundColor: '#F4E4A6' }}>
            {/* Keep current navbar */}
            <div className="hidden md:block">
                <Navbar />
            </div>

            {/* Hero Section - Yellow Bakery Style */}
            <section className="relative min-h-screen flex items-center justify-center px-6 pt-24 md:pt-32">
                {/* Large Bread Image - Left Side */}
                ...
                <div className="relative z-10 text-center max-w-3xl mx-auto">
                    {/* Main Heading */}
                    <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl font-bold leading-tight mb-6 text-sai-charcoal">
                        Sugar And Icing
                        <br />
                        <span className="block mt-2">Baked Fresh For You.</span>
                    </h1>

                    {/* Tagline */}
                    <p className="text-lg md:text-xl font-medium tracking-wider uppercase text-sai-charcoal/80 mb-8">
